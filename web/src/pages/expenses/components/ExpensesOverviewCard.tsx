          ...
          <div className="card-collapse-inner">
            ...
            <div className="mt-3.5 flex flex-col gap-2.5 sm:gap-3">
              {METRICS.map((metric) => (
                ...
                >
                  {/* Left Label Column */}
                  <div className="flex w-[160px] sm:w-[170px] shrink-0 items-center gap-2 min-w-0">
