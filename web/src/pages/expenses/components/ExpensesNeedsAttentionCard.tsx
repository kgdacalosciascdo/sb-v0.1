...
const ATTENTION_ITEMS: AttentionItem[] = [
  {
    ...
    subtitle: '₱5,750 overdue and requires follow-up',
    href: '#overdue-expenses',
  },
  {
    ...
    subtitle: '₱18,750 awaiting reimbursement',
    href: '#reimbursements-due',
  },
  {
    id: 'missing-receipts',
    count: 1,
    ...
    subtitle: '₱1000 of expenses has no supporting receipt.',
    href: '#missing-receipts',
  },
  {
    ...
    subtitle: '₱50,580 awaiting approval',
  ...
  },
  {
    ...
    subtitle: '3 expense payments totaling ₱50,580 may be duplicates.',
    href: '#possible-duplicates',
  },
]

export function ExpensesNeedsAttentionCard() {
              ...
              {ATTENTION_ITEMS.map((item) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center text-[11.5px] font-bold text-slate-900 group-hover:text-purple-800">
                      <span className="truncate">{item.title}</span>
                      <ChevronRight className="size-3 shrink-0 ml-0.5 text-slate-400 group-hover:translate-x-0.5 group-hover:text-purple-800 transition" />
                    </div>
