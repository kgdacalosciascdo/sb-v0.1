...
const PURCHASE_REPORTS: ReportItem[] = [
  {
    id: 'purchases-summary',
    title: 'Purchases Summary Report',
    description: 'Breakdown of cash and credit purchase orders and bills',
    href: '#purchases-summary-report',
  },
  {
    id: 'ap-aging',
    title: 'Accounts Payable Aging',
    description: 'Outstanding supplier balances by payment due bracket',
    href: '#ap-aging-report',
  },
  {
    id: 'supplier-ledger',
    title: 'Supplier Ledger & Statements',
    description: 'Itemized purchase orders, invoices, and payments',
    href: '#supplier-ledger',
  },
  {
    id: 'disbursement-summary',
    title: 'Disbursement & Settlement Summary',
    description: 'Disbursements and bank settlements by payment method',
    href: '#disbursement-summary-report',
  },
]

export function PurchasesReportsCard() {
