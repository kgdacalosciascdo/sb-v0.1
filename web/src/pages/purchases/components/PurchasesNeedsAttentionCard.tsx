...
const ATTENTION_ITEMS: AttentionItem[] = [
  {
    ...
    href: '#payables-due-today',
  },
  {
    id: 'overdue-supplier-balances',
    count: 1,
    badgeColor: 'bg-[#e53935] text-white',
  ...
  },
  {
    ...
    title: 'Voided or failed purchases',
...
export function PurchasesNeedsAttentionCard() {
