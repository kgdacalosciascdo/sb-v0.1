...
const SALES_REPORTS: ReportItem[] = [
  {
    id: 'sales-summary',
    title: 'Sales Summary Report',
    description: 'Breakdown of cash and credit sales transactions',
    href: '#sales-summary-report',
  },
  {
    id: 'ar-aging',
  ...
  },
  {
    ...
    description: 'Itemized billing and collection records per customer',
    href: '#customer-statement',
  },
  {
    id: 'cash-remittance',
    title: 'Cash Remittance Summary',
    description: 'Daily cash collections, shortages, and deposits',
    href: '#cash-remittance-summary',
  },
]
