...
const ATTENTION_ITEMS: AttentionItem[] = [
  ...
  },
  {
    ...
    subtitle: '₱1000 collection is not applied to customer receivables',
    href: '#unapplied-payments',
  },
  {
    id: 'voided-receipts',
    count: 7,
    badgeColor: 'bg-[#78909c] text-white',
    title: 'Voided or failed receipts',
...
export function CollectionsNeedsAttentionCard() {
