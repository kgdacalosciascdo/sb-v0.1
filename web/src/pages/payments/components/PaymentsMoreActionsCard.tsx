import { ChevronDown, GripVertical, Lock, FileText, Undo2, Users, ArrowDownToLine, Layers } from 'lucide-react'
import { useCardCollapse } from '../../../hooks/useCardCollapse'

export function PaymentsMoreActionsCard() {
            ...
            <div className="mt-3 flex flex-col gap-2">
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="truncate">Check Management</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="truncate">Customer Refund</span>
                </div>
                <Lock className="size-3.5 text-slate-400 shrink-0" />
              </a>

              {/* 3. Employee Cash Advance */}
              <a
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span className="truncate">Employee Cash Advance</span>
                </div>
                <Lock className="size-3.5 text-slate-400 shrink-0" />
              </a>
              ...
              >
                <ArrowDownToLine className="size-4 text-sky-700 shrink-0" />
                <span className="truncate">Owner Withdrawal</span>
              </a>
            </div>
