...
const METRICS: OverviewMetric[] = [
  ...
  {
    id: 'expense-payments-month',
    label: 'Expense Payments This Month',
    amount: 84300,
    dotColor: 'bg-[#fb8c00]',
  ...
  {
    id: 'other-payments-month',
    label: 'Other Payments This Month',
    amount: 312900,
    dotColor: 'bg-[#388e3c]',
          ...
          <div className="card-collapse-inner">
            ...
            <div className="mt-3.5 flex flex-col gap-2.5 sm:gap-3">
              {METRICS.map((metric) => (
                ...
                >
                  {/* Left Label Column */}
                  <div className="flex w-[170px] sm:w-[185px] shrink-0 items-center gap-2 min-w-0">
