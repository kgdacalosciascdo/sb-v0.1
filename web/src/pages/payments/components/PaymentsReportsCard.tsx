...
const PAYMENT_REPORTS: ReportItem[] = [
  {
    id: 'disbursements-summary',
    title: 'Disbursements Summary Report',
    description: 'Breakdown of supplier, expense, and other disbursements',
    href: '#disbursements-summary-report',
  },
  {
    id: 'check-register',
    title: 'Check Register & Issuance Report',
    description: 'Issued, cleared, stale, and voided bank checks',
    href: '#check-register-report',
  },
  {
    id: 'supplier-settlement',
    title: 'Supplier Settlement Report',
    description: 'Vouchers, invoices paid, and payment reference numbers',
    href: '#supplier-settlement-report',
  },
  {
    id: 'outflow-summary',
    title: 'Cash & Bank Outflow Summary',
    description: 'Total funds disbursed across all cash accounts',
    href: '#outflow-summary-report',
  },
]

export function PaymentsReportsCard() {
