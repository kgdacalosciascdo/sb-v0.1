...
const ACTIVITIES: ActivityItem[] = [
  ...
  },
  {
    id: 'act-2',
    date: '29 July 2026',
    activity: 'Utility expense paid - Meralco',
    amount: '₱8,450',
    user: 'KVL',
  },
  {
    id: 'act-3',
    date: '29 July 2026',
    activity: 'Employee cash advance released',
    amount: '₱5,000',
    user: 'CAL',
  },
  {
    id: 'act-4',
    date: '29 July 2026',
    activity: 'Check voided - Check#8819',
    amount: '₱1,200',
    user: 'KVL',
  },
  {
    id: 'act-5',
    date: '29 July 2026',
    activity: 'Customer refund payment released',
    amount: '₱1,000',
    user: 'CAL',
  },
]

export function PaymentsRecentActivityCard() {
